...
def generate_offspring(seed, mutation_rate_offspring, 
                       ...
                       mutation_rate_digit_down_minus, number_of_offspring):
    '''Generating offspring per parent with random mutations.
...
def calculate_score(offspring, target):
    '''Computing the distance from each of the offspring to the target seed.
...
def natural_selection() -> None:
    ...
    help_average_number_of_offspring = "Offspring rate per parent is randomly drawn from a poisson \
